...
- `AddressModel` — Country, AddressLine1/2, City, State, Zip, Extension (reusable for mailing & physical). Also owns the canonical static lists: `AddressModel.States` (75 entries: US states/territories, Canadian provinces, Armed Forces APO/FPO) and `AddressModel.Countries` (United States, Canada, Mexico)
