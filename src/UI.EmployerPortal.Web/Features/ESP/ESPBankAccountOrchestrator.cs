...
/// </summary>
public interface IESPBankAccountOrchestrator
{
    /// <summary>
...
/// <summary>
/// Default implementation of <see cref="IESPBankAccountOrchestrator"/>.
/// </summary>
internal class ESPBankAccountOrchestrator : IESPBankAccountOrchestrator
{
    ...
    {
        var existing = await _bankAccountService.GetExistingAccountsAsync();
            ...
            : existing.Any(a =>
        {
            ...
            : await _bankAccountService.SaveBankAccountAsync(model);
    }
    ...
    {
        return await _bankAccountService.GetBankAccountForEditAsync(bankAccountSk);
    }
    ...
    public async Task<IReadOnlyList<PendingPayment>> GetPendingPaymentsAsync(int bankAccountSk)
    {
        ...
        return employerSk is null ? [] : await _bankAccountService.GetPendingPaymentsAsync(bankAccountSk);
    }

    /// <inheritdoc/>
    public async Task<IReadOnlyList<SavedBankAccount>> GetExistingAccountsAsync()
    {
        return await _bankAccountService.GetExistingAccountsAsync();
    }
