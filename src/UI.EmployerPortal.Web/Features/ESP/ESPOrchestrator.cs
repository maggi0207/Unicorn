...
/// </summary>
public interface IESPOrchestrator
{
    /// <summary>
    ...
    /// </summary>
    Task SavePaymentToSessionAsync(string amount);
    /// <summary>
    ...
    /// <summary>
    /// GetFileUploadDetailSkFromSessionAsync
    /// </summary>
    /// <returns></returns>
    Task<int> GetFileUploadDetailSkFromSessionAsync();
    /// <summary>
...
/// <summary>
/// Default implementation of <see cref="IESPOrchestrator"/>.
/// </summary>
internal class ESPOrchestrator : IESPOrchestrator
{
    private readonly IBankAccountService _bankAccountService;
    private readonly ISessionManager _sessionManager;

    /// <summary>
    /// Initializes a new instance of <see cref="ESPOrchestrator"/>.
    /// </summary>
    public ESPOrchestrator(IBankAccountService bankAccountService, ISessionManager sessionManager)
    {
    ...
    public async Task SaveFileUploadDetailSkToSessionAsync(long sk)
    {
        var selectedEmployer = await _sessionManager.GetAsync<SelectedEmployerAccount>() ?? new SelectedEmployerAccount();
    ...
    public async Task<int> GetFileUploadDetailSkFromSessionAsync()
    {
        ...
        if (selectedEmployer.SelectedFileUploadDetailSK != null)
        {
            return Convert.ToInt32(selectedEmployer?.SelectedFileUploadDetailSK);
        }

        //if (selectedEmployer.EmployerAccount != null)
        //{
        //    var defaultAmount = !string.IsNullOrEmpty(selectedEmployer.SelectedFileUploadDetailSK) ? selectedEmployer.SelectedPaymentDetail.file : 0m;
        //    selectedEmployer?.SelectedFileUploadDetailSK = Convert.ToString(defaultAmount);
        //    return selectedEmployer?.SelectedFileUploadDetailSK;
        //}
        return 0;
    }
}
