...
/// <summary>View model for the ESP Payment Details page.</summary>
public sealed record EspPaymentDetailModel
{
    ...
    public ESPContactModel? ContactInfo { get; init; }

    /// <summary>Audit/activity history entries for the payment, ordered most-recent first.</summary>
    public IReadOnlyList<EspPaymentActivityItem> ActivityHistory { get; init; } = [];
}

/// <summary>A single row in the ESP Payment Activity history table.</summary>
public sealed record EspPaymentActivityItem
{
