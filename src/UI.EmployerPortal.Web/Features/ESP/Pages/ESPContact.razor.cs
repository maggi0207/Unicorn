...
/// /
/// </summary>
public partial class ESPContact
{
    ...
    /// </summary>
    public ESPContactModel Model { get; set; } = new();
    [Inject]
    private IESPPaymentACHContactService Espservice { get; set; } = default!;
    [Inject]
    ...
    private void GoBack()
    {
        ...
        if (Showback)
        {
            Nav.NavigateTo("esp/esp-make-payment-ach-information");
        }
    }
